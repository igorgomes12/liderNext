...
export const Demonstration: FC = () => {
  ...
  const { register, handleSubmit, formState: { errors } } = useForm<TDemonstrationData>({
      ...
      <form onSubmit={handleSubmit(SubmitHandler)}>
        <div className="w-80 flex mb-10 flex-col gap-4">
          ...
          <div className="grid w-full max-w-sm items-center gap-1.5">
            ...
            <Input {...register("whatsApp")} type="text" id="Whatsapp" placeholder="Whatsapp" />
          </div>
          ...
          <div className="grid w-full max-w-sm items-center gap-1.5">
            ...
            <Input {...register("state")} type="text" id="estado" placeholder="Estado" />
          </div>
          ...
          <Button type="submit" variant="secondaryLeader" size="lg" className="text-white">
            Enviar
          </Button>
        </div>
      </form>
