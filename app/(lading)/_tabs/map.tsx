...
const Map: FC<MapProps> = ({ center }) => {
  return (
    ...
    >
      <TileLayer attribution='&copy; <a href="http://maps.gstatic.com/">OpenStreetMap</a> contributors'
          url="https://{s}.basemaps.cartocdn.com/light_all/{z}/{x}/{y}{r}.jpg" 
      />
      {center && <Marker icon={myIcon} alt="Líder Automação" position={center as L.LatLngExpression} />}
    </MapContainer>
  );
};
