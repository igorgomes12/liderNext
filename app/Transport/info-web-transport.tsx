...
export const InfoWebTransport: FC = () => {
    return (
        <div className="flex w-full bg-gradient-to-b from-primaryLeader/80 to-white lg:px-20 lg:py-10 justify-between gap-2">
            <div className="hidden lg:flex w-6/12 px-8 py-8 items-start justify-center ">
                <Image
                    alt="imagem info"
            ...
            <div className="flex flex-col items-start w-full lg:w-6/12 justify-start gap-6 py-8 px-8">
